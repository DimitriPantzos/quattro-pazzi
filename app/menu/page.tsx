...
export const metadata: Metadata = {
  title: "Menu | Dinner, Lunch, Brunch & Wine",
  description:
    "Explore the Quattro Pazzi menu. Authentic Italian pasta, seafood, steaks, salads, and more. Sunday brunch and an extensive wine list.",
  alternates: {
